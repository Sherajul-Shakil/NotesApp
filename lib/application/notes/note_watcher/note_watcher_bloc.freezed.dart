...
class _$NoteWatcherStateTearOff {
  ...
  _LoadSucess loadSucess(dynamic notes) {
    return _LoadSucess(
      notes,
    );
  }
...
mixin _$NoteWatcherState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(dynamic notes) loadSucess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(dynamic notes)? loadSucess,
...
class __$LoadSucessCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_LoadSucess(
      notes == freezed ? _value.notes : notes,
    ));
  }
}
...
abstract class _LoadSucess implements NoteWatcherState {
  const factory _LoadSucess(dynamic notes) = _$_LoadSucess;
